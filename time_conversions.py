"""Contains functionality to convert time between units"""
...
def hhmm_to_seconds( hhmm: str ) -> int:
    """Converts time from  hhmm form to seconds"""
    if len(hhmm.split(':')) != 2:
...
def hhmmss_to_seconds( hhmmss: str ) -> int:
    """Converts time from  hhmmss form to seconds"""
...
def current_time_hhmm():
    """Returns current time in form hhmm"""
